...
export default function GoogleLoginButton() {
  ...
  const onFailure = (res: GoogleLoginResponseOffline | GoogleLoginResponse) => {
    if (res) console.log("GOOGLE LOGIN FAILED! res: ", res);
  };
  return (
      ...
      <GoogleLogin
        ...
        render={(renderProps) => (
          <button
            ...
            style={{
              width: "100%",
              backgroundColor: "#f8f9fa", // Whitish background (Bootstrap light)
              color: "#343a40", // Slightly darker text (Bootstrap dark)
              border: "1px solid #ced4da", // Light grey outline (Bootstrap border)
            }}
            type="submit"
